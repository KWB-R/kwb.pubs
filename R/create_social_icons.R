...
create_social_twitter <- function(twitter_name) {
  ...
  create_social_icon(icon = "twitter",
                     icon_pack = "fab",
                     link = sprintf("https://twitter.com/%s",
                                    twitter_name))
}
...
create_social_orcid <- function(orcid) {
  ...
  create_social_icon(icon = "orcid",
                     icon_pack = "ai",
                     link = sprintf("https://orcid.org/%s",
                                    orcid))
}

create_social_github <- function(github_name) {

  create_social_icon(icon = "github",
                     icon_pack = "fab",
                     link = sprintf("https://github.com/%s",
                                    github_name))
}

create_social_linkedin <- function(linkedin_name) {

  create_social_icon(icon = "linkedin",
                     icon_pack = "fab",
                     link = sprintf("https://linkedin.com/in/%s",
                                    linkedin_name))
}

create_social_researchgate <- function(researchgate_name) {

  create_social_icon(icon = "researchgate",
                     icon_pack = "ai",
                     link = sprintf("https://researchgate.net/profile/%s",
                                    researchgate_name))
}

create_social_googlescholar <- function(googlescholar_link) {

  create_social_icon(icon = "google-scholar",
                     icon_pack = "ai",
